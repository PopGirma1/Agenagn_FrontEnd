...
class NewListing extends React.Component {
	...
	submitNewListingApiRequest = async (newLaunchDetails) => {
		...
		let response = await backEndApi.post("/addhouse", {
			params: newLaunchDetails,
		});
			...
			<div className={classes.root}>
				...
				<Grid container className={classes.firstGrid} spacing={4}>
						...
						<form>
							...
							<div className={classes.inputsContainer}>
								...
								<Typography
									variant="body2"
									align="right"
									id="remainingCharacter"
									style={{ color: "#9e9e9e" }}>
									({this.characterCounter} Characters Remaining)
								</Typography>
								<Typography
									variant="body2"
									id="descriptionError"
									className={classes.inputError}>
									You have to write a description not less than 144 character.
								</Typography>
							</div>
							<div className={classes.inputsContainer}>
								...
								<select
									...
									<option value="Select Floor" disabled selected>
										Select Floor
									</option>
					...
					<Grid item xs={12} md={6}>
						...
						<div className={[classes.inputsContainer]}>
							<Typography variant="body2">
								Available for rent starting from
							</Typography>
						...
						<div className={classes.inputsContainer}>
							...
							<input
								type="text"
								placeholder="Enter product Network"
								className={classes.input}
							...
							<Typography
								...
								id="networkError"
								className={classes.inputError}>
								You have to enter product network.
							</Typography>
						</div>
						<div className={classes.inputsContainer}>
							...
							<textarea
								placeholder="Write note to reviewer"
								className={classes.textarea}
								onChange={this.onNoteToReviewerChanged}
								style={{ marginTop: "5px" }}
							/>
							<Typography
								variant="body2"
								id="noteToReviewerError"
								className={classes.inputError}>
								You have to enter a note to a reviewer
							</Typography>
						</div>
						<br />
						<br />
